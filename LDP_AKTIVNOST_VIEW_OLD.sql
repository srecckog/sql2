...
/****** Object:  View [dbo].[ldp_aktivnost_view]    Script Date: 11.04.2017. 15:21:45 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[ldp_aktivnost_view_OLD]
AS
SELECT        TOP (100) PERCENT id, datum, hala, linija, smjena, proizvod, norma, max, cijena, kolicina, iznos, norma * cijena AS norma_iznos, radnik, ID_Partner, ABS(kvarovi) AS kvarovi, 
                         ...
                         * cijena AS materijal_iznos, CASE WHEN stelanja > 0 THEN 1 ELSE 0 END AS Broj_Stelanja, CASE WHEN kvarovi > 0 THEN 1 ELSE 0 END AS Broj_Kvarova, CASE WHEN DATEDIFF(d, datum, getdate()) 
                         ...
                         > 1 THEN kolicina + skart_materijal + skart_obrada ELSE 0 END AS UKUPNO_TURM, [max]*cijena as norma_iznos2 , [max] * 480 / 450 AS norma8_kol,[max]*cijena* 480/450 as norma8_EUR, [max] * 480 / 450 * 85 / 100 AS norma_85, [max] * 480 / 450 * 75 / 100 AS norma8_75, 
                         [max] * cijena * 480 / 450 AS norma8iznos, [max] * cijena * 480 / 450 * 85 / 100 AS norma_85iznos, [max] * cijena * 480 / 450 * 75 / 100 AS norma8_75iznos, round(650/3,1) pausal
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[15] 4[13] 2[43] 3) )"
      End
   ...
   Begin DataPane = 
      ...
      Begin ColumnWidths = 83
         ...
         Width = 1500
         Width = 1500
         Width' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ldp_aktivnost_view'
GO
