...
--SELECT MTT.*, FCP.Tokarenje, FCP.Kaljenje, FCP.CijenaProQ1, FCP.CijenaProQ2, FCP.CijenaProQ3, FCP.CijenaProQ4 
--       FROM MyTmpTable MTT 
--       LEFT JOIN FakturneCijeneProizvoda FCP ON MTT.ID_FCP = FCP.ID_FCP
--	   where id_par=274


SELECT case when zavrsnaobrada='Tvrdo tokarenje' then Spremnott_pro when zavrsnaobrada='Kaljenje' then spremnok_pro when zavrsnaobrada='Tokarenje' then spremnot_pro end spremno_koli, MTT.*, FCP.Tokarenje, FCP.Kaljenje, FCP.CijenaProQ1, FCP.CijenaProQ2, FCP.CijenaProQ3, FCP.CijenaProQ4 
       FROM MyTmpTable MTT 
       LEFT JOIN FakturneCijeneProizvoda FCP ON MTT.ID_FCP = FCP.ID_FCP
	   where id_par=274
