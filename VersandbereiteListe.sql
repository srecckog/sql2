 ...
 from (
 SELECT 
     StanjeProizvodnjeList.Bazni_RN, 
     (SELECT NarudzbeDetaljnoView.OrderNo FROM NarudzbeDetaljnoView WHERE NarudzbeDetaljnoView.BrojRN = (CASE WHEN StanjeProizvodnjeList.ZavrsnaObrada = 'Kaljenje' THEN StanjeProizvodnjeList.RN_Kaljenje WHEN StanjeProizvodnjeList.ZavrsnaObrada = 'Tvrdo tokarenje' THEN StanjeProizvodnjeList.RN_TvrdoTokarenje WHEN StanjeProizvodnjeList.ZavrsnaObrada = 'Brusenje' THEN StanjeProizvodnjeList.RN_Brusenje ELSE StanjeProizvodnjeList.RN_Tokarenje END)) AS Narudzba, 
     ...
     StanjeProizvodnjeList.BaznaObrada,
	 StanjeProizvodnjeList.ZavrsnaObrada, 
	 StanjeProizvodnjeList.RN_Tokarenje, 
	 StanjeProizvodnjeList.SpremnoT_Pro, 
	 StanjeProizvodnjeList.SpremnoT_Pak,
     StanjeProizvodnjeList.PakiranjeT_Pro, 
	 StanjeProizvodnjeList.PakiranjeT_kg, 
	 StanjeProizvodnjeList.RN_Kaljenje, 
	 StanjeProizvodnjeList.SpremnoK_Pro, 
	 StanjeProizvodnjeList.SpremnoK_Pak, 
     StanjeProizvodnjeList.PakiranjeK_Pro, 
	 StanjeProizvodnjeList.PakiranjeK_kg, 
     StanjeProizvodnjeList.RN_TvrdoTokarenje , 
	 StanjeProizvodnjeList.SpremnoTT_Pro, 
	 StanjeProizvodnjeList.SpremnoTT_Pak, 
	 StanjeProizvodnjeList.PakiranjeTT_Pro, 
	 StanjeProizvodnjeList.PakiranjeTT_kg, 
     StanjeProizvodnjeList.RN_Brusenje , 
	 StanjeProizvodnjeList.SpremnoBR_Pro, 
	 StanjeProizvodnjeList.SpremnoBR_Pak, 
	 StanjeProizvodnjeList.PakiranjeBR_Pro, 
	 StanjeProizvodnjeList.PakiranjeBR_kg, 
     StanjeProizvodnjeList.KolicinaNar, 
	 StanjeProizvodnjeList.IsporucenoT_Pro, 
	 StanjeProizvodnjeList.IsporucenoK_Pro, 
	 StanjeProizvodnjeList.IsporucenoTT_Pro, 
	 StanjeProizvodnjeList.IsporucenoBR_Pro, 
	 ...
	 where x.proizvod  like '%F-588258-3005.AU.TR1-W220-W240F%'
     
	 ORDER BY VlasnistvoFX, Proizvod