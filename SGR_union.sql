...
select x2.narucitelj Naruèitelj, VlasnistvoFX, sum(x2.Iznosmat+x2.IznosObr) UkupnoDovrseno_EUR, 0 UkupnoNedovrseno_EUR,sum(x2.Iznosmat+x2.IznosObr) Ukupno_EUR, 'Tokareno' VrstaObrade
from(
...
select x2.narucitelj Naruèitelj, VlasnistvoFX, sum(x2.Iznosmat+x2.IznosObr) as UkupnoDovrseno_EUR , sum(x2.NeodvrsenoMat+NedovrsenoObr) as UkupnoNedovrseno_EUR, sum(x2.Iznosmat+x2.IznosObr+x2.NeodvrsenoMat+NedovrsenoObr) Ukupno_EUR,'Kaljeno' VrstaObrade
from(
...
-- tvrdo tokareno --
select x2.narucitelj Naruèitelj, VlasnistvoFX, sum(x2.Iznosmat+x2.IznosObr) UkupnoDovrseno_EUR ,sum(NedovrsenoMat+NedovrsenoIznosObr) UkupnoNedovrseno_EUR,sum(x2.Iznosmat+x2.IznosObr+NedovrsenoMat+NedovrsenoIznosObr) Ukupno_EUR,'TvrdoTokarenje' VrstaObrade
from(
...
SELECT Narucitelj,VlasnistvoFx, sum((x1.cijenaprokom * x1.Spremnot_pro)) as UkupnoDovrseno_EUR, 0 UkupnoNedovrseno_EUR,sum(x1.cijenaprokom * x1.Spremnot_pro) Ukupno_EUR, 'Valjèiæi' VrstaObrade
from (
select
